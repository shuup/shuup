...
from shuup.testing.utils import apply_request_middleware, apply_view_middleware
...
def get_bs_object_for_view(request, view, user, object=None):
    ...
    with override_provides("service_provider_admin_form", [
        ...
        request = apply_view_middleware(apply_request_middleware(request, user=user))
