...
from shuup.campaigns.models.catalog_filters import CategoryFilter, ProductFilter, ProductTypeFilter, CatalogFilter
from shuup.core.models import Category, ShopProduct
from shuup.testing.factories import get_default_category, create_product
