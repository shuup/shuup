...
from shuup_tests.front.utils import get_registration_multishop_configuration
...
def test_registration_person_multiple_shops(django_user_model, client):
    ...
    with patch("shuup.configuration.get", new=get_registration_multishop_configuration):
