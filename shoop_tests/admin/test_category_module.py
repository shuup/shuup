...
from shoop.admin.modules.categories import CategoryModule
from shoop.admin.modules.categories.views.edit import CategoryBaseForm
from shoop.testing.factories import CategoryFactory
