...
from shuup.admin.toolbar import ProvideActionItem


class CreatePaymentAction(ProvideActionItem):
    def __init__(self, object, **kwargs):
        ...
        super(CreatePaymentAction, self).__init__(object, **kwargs)
...
class CreateShipmentAction(ProvideActionItem):
    def __init__(self, object, **kwargs):
        ...
        super(CreateShipmentAction, self).__init__(object, **kwargs)
...
class CreateRefundAction(ProvideActionItem):
    def __init__(self, object, **kwargs):
        ...
        super(CreateRefundAction, self).__init__(object, **kwargs)
