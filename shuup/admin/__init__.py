...
class ShuupAdminAppConfig(AppConfig):
    ...
    provides = {
        ...
        "admin_order_toolbar_action_item": [
            "shuup.admin.modules.orders.action_items:CreatePaymentAction",
            "shuup.admin.modules.orders.action_items:CreateShipmentAction",
            "shuup.admin.modules.orders.action_items:CreateRefundAction",
        ]
    }
