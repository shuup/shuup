    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contacts', models.ManyToManyField(to='shuup.Contact', verbose_name='contacts')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('basketcondition_ptr', models.OneToOneField(parent_link=True, auto_created=True, primary_key=True, serialize=False, to='campaigns.BasketCondition')),
                ('contact_groups', models.ManyToManyField(to='shuup.ContactGroup', verbose_name='contact groups')),
            ],
            options={
                'abstract': False,
            },
