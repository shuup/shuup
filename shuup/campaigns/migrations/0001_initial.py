    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identifier', shuup.core.fields.InternalIdentifierField(null=True, editable=False, unique=True, max_length=64, blank=True)),
                ...
                ('discount_amount_value', shuup.core.fields.MoneyValueField(help_text='Flat amount of discount. Mutually exclusive with percentage.', null=True, max_digits=36, decimal_places=9, verbose_name='discount amount value', blank=True, default=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount_value', shuup.core.fields.MoneyValueField(null=True, max_digits=36, decimal_places=9, verbose_name='basket total amount', blank=True, default=None)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('basketcondition_ptr', models.OneToOneField(primary_key=True, to='campaigns.BasketCondition', parent_link=True, serialize=False, auto_created=True)),
                ('products', models.ManyToManyField(to='shuup.Product', verbose_name='products', blank=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='catalogcampaign',
            name='shop',
            field=models.ForeignKey(help_text='The shop where campaign is active.', verbose_name='shop', to='shuup.Shop'),
        ),
        migrations.AddField(
