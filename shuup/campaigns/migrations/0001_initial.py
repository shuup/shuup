    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('master', models.ForeignKey(related_name='translations', to='campaigns.BasketCampaign', null=True, editable=False)),
            ],
            options={
                'db_tablespace': '',
                'default_permissions': (),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('master', models.ForeignKey(related_name='translations', to='campaigns.CatalogCampaign', null=True, editable=False)),
            ],
            options={
                'db_tablespace': '',
                'default_permissions': (),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(related_name='+', to='shuup.ContactGroup', verbose_name='group')),
                ('shop', models.ForeignKey(related_name='+', to='shuup.Shop', verbose_name='shop')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL, null=True, verbose_name='created by')),
                ('modified_by', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to=settings.AUTH_USER_MODEL, null=True, verbose_name='modified by')),
                ('order', models.ForeignKey(related_name='coupon_usages', to='shuup.Order')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('basketdiscounteffect_ptr', models.OneToOneField(to='campaigns.BasketDiscountEffect', parent_link=True, serialize=False, auto_created=True, primary_key=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('basketcondition_ptr', models.OneToOneField(to='campaigns.BasketCondition', parent_link=True, serialize=False, auto_created=True, primary_key=True)),
        ...
        migrations.CreateModel(
            name='CategoryFilter',
            fields=[
                ('catalogfilter_ptr', models.OneToOneField(to='campaigns.CatalogFilter', parent_link=True, serialize=False, auto_created=True, primary_key=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('contextcondition_ptr', models.OneToOneField(to='campaigns.ContextCondition', parent_link=True, serialize=False, auto_created=True, primary_key=True)),
                ('contacts', models.ManyToManyField(verbose_name='contacts', to='shuup.Contact')),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('basketlineeffect_ptr', models.OneToOneField(to='campaigns.BasketLineEffect', parent_link=True, serialize=False, auto_created=True, primary_key=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('productdiscounteffect_ptr', models.OneToOneField(to='campaigns.ProductDiscountEffect', parent_link=True, serialize=False, auto_created=True, primary_key=True)),
                ('discount_amount', shuup.core.fields.MoneyValueField(blank=True, null=True, verbose_name='discount amount', help_text='Flat amount of discount.', decimal_places=9, default=None, max_digits=36)),
            ],
            options={
                'abstract': False,
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(related_name='polymorphic_campaigns.productdiscounteffect_set+', to='contenttypes.ContentType', null=True, editable=False),
        ),
        migrations.AddField(
            model_name='contextcondition',
            name='polymorphic_ctype',
            field=models.ForeignKey(related_name='polymorphic_campaigns.contextcondition_set+', to='contenttypes.ContentType', null=True, editable=False),
        ),
        migrations.AddField(
            model_name='catalogfilter',
            name='polymorphic_ctype',
            field=models.ForeignKey(related_name='polymorphic_campaigns.catalogfilter_set+', to='contenttypes.ContentType', null=True, editable=False),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='catalogcampaign',
            name='shop',
            field=models.ForeignKey(to='shuup.Shop', verbose_name='shop', help_text='The shop where campaign is active.'),
        ),
        migrations.AddField(
            model_name='basketlineeffect',
            name='campaign',
            field=models.ForeignKey(related_name='line_effects', to='campaigns.BasketCampaign', verbose_name='campaign'),
        ),
        migrations.AddField(
            model_name='basketlineeffect',
            name='polymorphic_ctype',
            field=models.ForeignKey(related_name='polymorphic_campaigns.basketlineeffect_set+', to='contenttypes.ContentType', null=True, editable=False),
        ),
        migrations.AddField(
            model_name='basketdiscounteffect',
            name='campaign',
            field=models.ForeignKey(related_name='discount_effects', to='campaigns.BasketCampaign', verbose_name='campaign'),
        ),
        migrations.AddField(
            model_name='basketdiscounteffect',
            name='polymorphic_ctype',
            field=models.ForeignKey(related_name='polymorphic_campaigns.basketdiscounteffect_set+', to='contenttypes.ContentType', null=True, editable=False),
        ),
        migrations.AddField(
            model_name='basketcondition',
            name='polymorphic_ctype',
            field=models.ForeignKey(related_name='polymorphic_campaigns.basketcondition_set+', to='contenttypes.ContentType', null=True, editable=False),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='basketcampaign',
            name='coupon',
            field=models.OneToOneField(verbose_name='coupon', blank=True, related_name='campaign', to='campaigns.Coupon', null=True),
        ),
        migrations.AddField(
            model_name='basketcampaign',
            name='created_by',
