...
from shuup.admin.forms.widgets import Select2Multiple
...
class CampaignFormMixin(object):
    ...
    def _get_values_for_identifier(self, key, identifier):
        ...
        `identifier` is an identifier string available in:
          * `shuup.campaigns.basket_conditions.BasketCondition`
          * `shuup.campaigns.catalog_filters.CatalogFilter`
          * `shuup.campaigns.context_conditions.ContextCondition`
