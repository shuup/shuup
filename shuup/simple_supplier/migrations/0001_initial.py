    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(related_name='+', to='shuup.Product', verbose_name='product')),
                ('supplier', models.ForeignKey(verbose_name='supplier', to='shuup.Supplier')),
            ],
        ),
        migrations.CreateModel(
            name='StockCount',
            fields=[
                ...
                ('product', models.ForeignKey(related_name='+', to='shuup.Product', editable=False, verbose_name='product')),
                ('supplier', models.ForeignKey(to='shuup.Supplier', editable=False, verbose_name='supplier')),
            ],
        ),
