...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.ManyToManyField(verbose_name='customer tax groups', blank=True, to='shuup.CustomerTaxGroup'),
        ),
        migrations.AlterField(
            model_name='taxrule',
        ...
        migrations.AlterField(
            model_name='taxrule',
            name='tax',
            field=models.ForeignKey(verbose_name='tax', to='shuup.Tax', on_delete=django.db.models.deletion.PROTECT),
        ),
        migrations.AlterField(
            model_name='taxrule',
            name='tax_classes',
            field=models.ManyToManyField(verbose_name='tax classes', to='shuup.TaxClass', help_text='Tax classes of the items to be taxed'),
        ),
    ]
