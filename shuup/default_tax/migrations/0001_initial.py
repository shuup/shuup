    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer_tax_groups', models.ManyToManyField(to='shuup.CustomerTaxGroup')),
                ('tax', models.ForeignKey(to='shuup.Tax')),
                ('tax_classes', models.ManyToManyField(to='shuup.TaxClass')),
            ],
        ),
    ]
