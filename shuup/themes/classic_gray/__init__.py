...
class ClassicGrayTheme(Theme):
    ...
    def get_view(self, view_name):
        import shuup.themes.classic_gray.views as views
...
class ClassicGrayThemeAppConfig(AppConfig):
    ...
    provides = {
        "xtheme": "shuup.themes.classic_gray:ClassicGrayTheme",
        "xtheme_plugin": [
            "shuup.themes.classic_gray.plugins:ProductHighlightPlugin",
            "shuup.themes.classic_gray.plugins:ProductCrossSellsPlugin",
        ],
    }


default_app_config = "shuup.themes.classic_gray.ClassicGrayThemeAppConfig"
