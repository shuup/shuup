...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='storedbasket',
            name='customer',
            field=models.ForeignKey(null=True, related_name='customer_baskets', blank=True, to='shuup.Contact'),
        ),
        migrations.AddField(
            model_name='storedbasket',
            name='orderer',
            field=models.ForeignKey(null=True, related_name='orderer_baskets', blank=True, to='shuup.PersonContact'),
        ),
        migrations.AddField(
            model_name='storedbasket',
        ...
        migrations.AddField(
            model_name='storedbasket',
            name='shop',
            field=models.ForeignKey(to='shuup.Shop', default=1),
            preserve_default=False,
        ),
    ]
