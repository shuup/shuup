...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('shuup_front', '0002_tax_price_currency'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='storedbasket',
            name='customer',
            field=models.ForeignKey(verbose_name='customer', blank=True, null=True, related_name='customer_baskets', to='shuup.Contact'),
        ),
        migrations.AlterField(
            model_name='storedbasket',
            name='data',
        ...
        migrations.AlterField(
            model_name='storedbasket',
            name='key',
            field=models.CharField(verbose_name='key', max_length=32, default=shuup.front.models.stored_basket.generate_key),
        ),
        migrations.AlterField(
            model_name='storedbasket',
            name='orderer',
            field=models.ForeignKey(verbose_name='orderer', blank=True, null=True, related_name='orderer_baskets', to='shuup.PersonContact'),
        ),
        migrations.AlterField(
            model_name='storedbasket',
            name='persistent',
        ...
        migrations.AlterField(
            model_name='storedbasket',
            name='products',
            field=models.ManyToManyField(verbose_name='products', blank=True, to='shuup.Product'),
        ),
        migrations.AlterField(
            model_name='storedbasket',
            name='shop',
        ...
        migrations.AlterField(
            ...
            field=shuup.core.fields.MoneyValueField(max_digits=36, blank=True, null=True, verbose_name='taxful total price', decimal_places=9, default=0),
        ),
        migrations.AlterField(
            model_name='storedbasket',
            name='taxless_total_price_value',
            field=shuup.core.fields.MoneyValueField(max_digits=36, blank=True, null=True, verbose_name='taxless total price', decimal_places=9, default=0),
        ),
        migrations.AlterField(
            model_name='storedbasket',
            name='title',
