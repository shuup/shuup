...
urlpatterns = [
    ...
    url(r'^address-book/edit/new$', login_required(views.AddressBookEditView.as_view()),
        name='address_book_new'),
    url(r'^address-book/delete/(?P<pk>\d+)$', login_required(views.delete_address),
