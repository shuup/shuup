    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(related_name='ultrafilte5', to='shuup.Category', null=True)),
                ('contact', models.ForeignKey(to='shuup.Contact', null=True)),
                ('derp', models.ForeignKey(related_name='ultrafilte55', to='shuup.Category', null=True)),
                ('product', models.ForeignKey(to='shuup.Product', null=True)),
                ('product_type', models.ForeignKey(to='shuup.ProductType', null=True)),
                ...
                ('shop_product', models.ForeignKey(to='shuup.ShopProduct', null=True)),
