...
class TimeRange(models.Model):
    ...
    from_hour = models.TimeField(null=True, blank=True, verbose_name=_("from hour"))
    to_hour = models.TimeField(null=True, blank=True, verbose_name=_("to hour"))
    weekday = models.CharField(null=True, blank=True, max_length=255, verbose_name=_("weekdays"))
