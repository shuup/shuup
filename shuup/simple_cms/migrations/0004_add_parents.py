...
def rebuild_pages(apps, schema_editor):
    ...
    page_model = apps.get_model("shuup_simple_cms", "Page")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('shuup_simple_cms', '0003_verbose_names'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='page',
            name='parent',
            field=mptt.fields.TreeForeignKey(related_name='children', verbose_name='parent', blank=True, to='shuup_simple_cms.Page', null=True),
        ),
        migrations.AddField(
            model_name='page',
            name='rght',
