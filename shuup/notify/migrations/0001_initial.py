    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recipient_type', enumfields.fields.EnumIntegerField(default=1, enum=shuup.notify.enums.RecipientType)),
                ('created_on', models.DateTimeField(auto_now_add=True)),
                ('message', models.CharField(default='', editable=False, max_length=140)),
                ('identifier', shuup.core.fields.InternalIdentifierField(verbose_name='internal identifier', help_text="Do not change this value if you are not sure what you're doing.", editable=False, unique=True, null=True, blank=True, max_length=64)),
                ('priority', enumfields.fields.EnumIntegerField(default=2, enum=shuup.notify.enums.Priority, db_index=True)),
