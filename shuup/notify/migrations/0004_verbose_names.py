...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('shuup_notify', '0003_fk_on_delete'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='notification',
            name='priority',
            field=enumfields.fields.EnumIntegerField(db_index=True, verbose_name='priority', default=2, enum=shuup.notify.enums.Priority),
        ),
        migrations.AlterField(
            model_name='notification',
            name='recipient',
        ...
        migrations.AlterField(
            model_name='notification',
            name='recipient_type',
            field=enumfields.fields.EnumIntegerField(verbose_name='recipient type', enum=shuup.notify.enums.RecipientType, default=1),
        ),
        migrations.AlterField(
            model_name='script',
            name='created_on',
