...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='identifier',
            field=shuup.core.fields.InternalIdentifierField(unique=True, blank=False, max_length=64, null=False, editable=False),
        ),
        migrations.AlterField(
            model_name='orderstatus',
            name='identifier',
            field=shuup.core.fields.InternalIdentifierField(unique=True, blank=False, db_index=True, max_length=64, null=False, editable=False),
        ),
        migrations.AlterField(
            model_name='productvariationvariable',
            name='identifier',
            field=shuup.core.fields.InternalIdentifierField(blank=True, unique=False, max_length=64, null=True, editable=False),
        ),
        migrations.AlterField(
