...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            name='_data',
            field=shuup.core.fields.TaggedJSONField(verbose_name='internal data', default=dict, db_column='data'),
        ),
        migrations.AlterField(
            model_name='savedviewconfig',
            name='created_on',
        ...
        migrations.AlterField(
            model_name='savedviewconfig',
            name='status',
            field=enumfields.fields.EnumIntegerField(db_index=True, verbose_name='status', enum=shuup.xtheme.models.SavedViewConfigStatus),
        ),
        migrations.AlterField(
            model_name='savedviewconfig',
        ...
        migrations.AlterField(
            model_name='themesettings',
            name='data',
            field=shuup.core.fields.TaggedJSONField(verbose_name='data', default=dict, db_column='data'),
        ),
        migrations.AlterField(
            model_name='themesettings',
            name='theme_identifier',
