...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.ManyToManyField(blank=True, verbose_name='Customer tax groups', to='shoop.CustomerTaxGroup'),
        ),
        migrations.AlterField(
            model_name='taxrule',
        ...
        migrations.AlterField(
            model_name='taxrule',
            name='tax_classes',
            field=models.ManyToManyField(verbose_name='Tax classes', help_text='Tax classes of the items to be taxed', to='shoop.TaxClass'),
        ),
    ]
