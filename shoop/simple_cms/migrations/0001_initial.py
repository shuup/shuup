    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identifier', shoop.core.fields.InternalIdentifierField(verbose_name='internal identifier', help_text='This identifier can be used in templates to create URLs', editable=False, unique=True, null=True, blank=True, max_length=64)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('master', models.ForeignKey(editable=False, null=True, to='shoop_simple_cms.Page', related_name='translations')),
            ],
            options={
                'verbose_name': 'page Translation',
                'default_permissions': (),
                'managed': True,
                'db_table': 'shoop_simple_cms_page_translation',
                'db_tablespace': '',
            },
        ),
