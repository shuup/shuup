    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identifier', shoop.core.fields.InternalIdentifierField(unique=True, null=True, blank=True, editable=False, max_length=64)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', primary_key=True, serialize=False, auto_created=True)),
                ('min_value', shoop.core.fields.MoneyValueField(verbose_name='min amount', null=True, blank=True, max_digits=36, decimal_places=9)),
                ('max_value', shoop.core.fields.MoneyValueField(verbose_name='max amount', null=True, blank=True, max_digits=36, decimal_places=9)),
                ('group', models.ForeignKey(verbose_name='group', to='shoop.ContactGroup', related_name='+')),
                ('shop', models.ForeignKey(verbose_name='shop', to='shoop.Shop', related_name='+')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(verbose_name='created by', to=settings.AUTH_USER_MODEL, on_delete=django.db.models.deletion.SET_NULL, null=True, blank=True, related_name='+')),
                ('modified_by', models.ForeignKey(verbose_name='modified by', to=settings.AUTH_USER_MODEL, on_delete=django.db.models.deletion.SET_NULL, null=True, blank=True, related_name='+')),
                ('order', models.ForeignKey(to='shoop.Order', related_name='coupon_usages')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount_amount', shoop.core.fields.MoneyValueField(verbose_name='discount amount', decimal_places=9, max_digits=36, default=None, null=True, blank=True, help_text='Flat amount of discount.')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount_value', shoop.core.fields.MoneyValueField(verbose_name='maximum basket total amount', decimal_places=9, max_digits=36, default=None, null=True, blank=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('basketcondition_ptr', models.OneToOneField(to='campaigns.BasketCondition', serialize=False, auto_created=True, primary_key=True, parent_link=True)),
                ('amount_value', shoop.core.fields.MoneyValueField(verbose_name='basket total amount', decimal_places=9, max_digits=36, default=None, null=True, blank=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('basketcondition_ptr', models.OneToOneField(to='campaigns.BasketCondition', serialize=False, auto_created=True, primary_key=True, parent_link=True)),
                ('contacts', models.ManyToManyField(verbose_name='contacts', to='shoop.Contact')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('basketcondition_ptr', models.OneToOneField(to='campaigns.BasketCondition', serialize=False, auto_created=True, primary_key=True, parent_link=True)),
                ('quantity', models.PositiveIntegerField(verbose_name='quantity', default=1)),
                ('products', models.ManyToManyField(verbose_name='products', blank=True, to='shoop.Product')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            model_name='catalogcampaign',
            name='shop',
            field=models.ForeignKey(verbose_name='shop', to='shoop.Shop', help_text='The shop where campaign is active.'),
        ),
        migrations.AddField(
