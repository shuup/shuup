    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('taxless_total', shoop.core.fields.MoneyValueField(max_digits=36, null=True, decimal_places=9, default=0, blank=True)),
                ('taxful_total', shoop.core.fields.MoneyValueField(max_digits=36, null=True, decimal_places=9, default=0, blank=True)),
