...
import shoop.core.models._base
import shoop.core.fields
import shoop.utils.models
...
def copy_order_addresses(apps, schema_editor):
    ...
    """
    order_cls = apps.get_model("shoop", "Order")
    immutable_address_cls = apps.get_model("shoop", "ImmutableAddress")
    ...
    for order in order_cls.objects.all():
        if order.mutable_billing_address:
            order.billing_address = immutable_address_cls.objects.get_or_create(
                **shoop.utils.models.get_data_dict(order.mutable_billing_address))[0]

        if order.mutable_shipping_address:
            order.shipping_address = immutable_address_cls.objects.get_or_create(
                **shoop.utils.models.get_data_dict(order.mutable_shipping_address))[0]
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            bases=(shoop.core.models._base.ChangeProtected, shoop.core.utils.name_mixin.NameMixin, models.Model),
        ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(related_name='billing_orders', on_delete=django.db.models.deletion.PROTECT, verbose_name='billing address', blank=True, to='shoop.ImmutableAddress', null=True),
        ),
        migrations.AddField(
            model_name='order',
            name='shipping_address',
            field=models.ForeignKey(related_name='shipping_orders', on_delete=django.db.models.deletion.PROTECT, verbose_name='shipping address', blank=True, to='shoop.ImmutableAddress', null=True),
        ),
