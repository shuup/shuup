...
See also source code of :obj:`shoop.core.settings`.
...
Applications in :term:`Shoop Base` distribution should use the following
rules for naming their settings.
 ...
 2. Boolean toggle settings should have a verb in imperative mood as
    part of the name, e.g. `SHOOP_ALLOW_ANONYMOUS_ORDERS`,
    `SHOOP_ENABLE_ATTRIBUTES` or `SHOOP_ENABLE_MULTIPLE_SHOPS`.
