...
def validate_templates_configuration():
    ...
    Shoop's admin and default frontend require some Django-Jinja configuration, so
    ...
    for template_engine in django.conf.settings.TEMPLATES:
        ...
        if "DjangoTemplates" in backend:
            raise ImproperlyConfigured(
                ...
                "before Django-Jinja. This configuration will not work correctly with Shoop."
            )
